...
namespace mFramework.UI
{
    ...
    public struct UIColor : IEquatable<UIColor>
    {
        ...
        /// <returns></returns>
        public static UIColor ParseHex(string hexColor, float opacity = 1f)
        {
            Color color;
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 397) ^ N1.GetHashCode();
                hashCode = (hashCode * 397) ^ N2.GetHashCode();
                hashCode = (hashCode * 397) ^ N3.GetHashCode();
